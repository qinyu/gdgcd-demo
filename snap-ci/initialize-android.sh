...
if [ ! -e ${INITIALIZATION_FILE} ]; then
  ...
  - echo y | android update sdk --no-ui --all -s --filter tools-preview,platform-tools-preview,build-tools-24.0.0-preview,android-N,extra-android-support,extra-android-m2repository
